...
for i in SRR3191542  ; do
	mkdir ${i}/kallisto
	rm ${i}/kallisto/*
	kallisto pseudo -i ~/human/human_gtf.idx -o ${i}/kallisto ${i}/${i}_1.fastq ${i}/${i}_2.fastq
	...
	/home/lynnyi/kallisto_del/kallisto/build/src/kallisto pseudoquant -i ~/human/human_gtf.idx -o ${i}/kallisto -d ${i}/kallisto -l 187 -s 70
done
